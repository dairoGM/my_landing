...
const WA_DAIRO_DISPLAY  = '+53 55848425'
const WA_YAMILA_DISPLAY = '+53 53572771'
  ...
  return (
    <>
      ...
      <section
        id="contacto"
        ref={ref}
        style={{ padding: '6rem 2rem', background: 'var(--dark)', position: 'relative', overflow: 'hidden' }}
      >
        <div style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            >
              <div style={{
                display: 'inline-block', padding: '0.3rem 0.9rem', borderRadius: 6,
                background: 'rgba(108,99,255,0.12)', border: '1px solid rgba(108,99,255,0.3)',
                color: 'var(--primary-light)', fontSize: '0.78rem', fontWeight: 600,
              ...
              <h2 style={{
                ...
                }}>construir juntos?</span>
              </h2>

              <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '2.5rem', fontSize: '1rem' }}>
                Cuéntanos sobre tu proyecto. Analizamos tus necesidades y te proponemos
                la solución más eficiente. La primera consulta es sin costo.
              </p>

              {[
                { label: 'Dairo — WhatsApp', value: WA_DAIRO_DISPLAY, href: 'https://wa.me/5355848425' },
                { label: 'Yamila — WhatsApp', value: WA_YAMILA_DISPLAY, href: 'https://wa.me/5353572771' },
              ].map((c, i) => (
            ...
            >
              <h3 style={{ fontWeight: 700, fontSize: '1.15rem', marginBottom: '1.75rem', color: 'var(--text)' }}>
                Enviar mensaje
              </h3>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.5rem' }}>
                    <FileText size={13} /> Asunto
                  </label>
                  <input type="text" value={form.subject} onChange={set('subject')} placeholder="¿De qué trata tu proyecto?"
                    style={inputBase}
                    onFocus={e => e.target.style.borderColor = 'var(--primary)'}
                    onBlur={e => e.target.style.borderColor = 'var(--glass-border)'}
                  />
                ...
                <div>
                  ...
                  <textarea value={form.message} onChange={set('message')} placeholder="Cuéntanos sobre tu idea o necesidad..."
                    rows={4}
                ...
                {error && (
                  <p style={{
                    ...
                    color: '#ff6b6b', fontSize: '0.82rem', lineHeight: 1.5,
                  }}>
                    {error}
                  </p>
                )}
                ...
                <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textAlign: 'center', lineHeight: 1.5 }}>
                  Tu mensaje llegará por correo y WhatsApp a nuestro equipo.
                </p>
              </div>
            </motion.div>
          </div>
